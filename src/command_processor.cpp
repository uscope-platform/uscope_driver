...
command_processor::command_processor(const std::string &driver_file, unsigned int dma_buffer_size, bool emulate_control, bool log) : hw(driver_file, dma_buffer_size, emulate_control, log) {
    logging_enabled = log;
}
